  ...
  handleState(message, socket) {
    ...
    */
    if (stateChange.action === 'update') {
      ...
      //const newState = [
      //{timestamp: 1/4/2021 11:34am, message: "hello world", user: user1},
      //{timestamp: 1/4/2021 11:34am, message: "hello world2", user: user2},
      //{timestamp: 1/4/2021 11:34am, message: "hello world3", user: user3},
      //]
      //const newState = [
      //{user 1: [state]},
      //{user 2: [state2]}
      ...
      db.find({ session: stateChange.session }).then((sessionRecords) => {
        ...
        db.create({ session: stateChange.session, state: newState })
          .then((data) => {
